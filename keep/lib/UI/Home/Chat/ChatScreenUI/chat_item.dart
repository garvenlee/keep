            ...
            Bubble(
                ...
                child: Container(
                    constraints: BoxConstraints(
                        maxWidth: MediaQuery.of(context).size.width - 175.0),
                    // decoration:
    ...
    if (widget.isSelf) {
      ...
      return Container(
        ...
        child: widget.avatar == 'null'
            ...
            : CircleAvatar(radius: 25.0, backgroundImage: widget.avatar),
      );
    } else {
      return Container(
    ...
    if (widget.isSelf) {
      ...
      return widget.animationController != null
          ? SizeTransition(
              key: UniqueKey(),
              sizeFactor: new CurvedAnimation(
                  parent: widget.animationController, curve: Curves.slowMiddle),
              axisAlignment: 0.0,
              child: Container(
                  margin: EdgeInsets.symmetric(vertical: 8.0),
                  child: Column(children: <Widget>[
